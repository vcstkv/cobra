"""
evaluate_spacethinker.py

Minimal script to evaluate SpaceThinker-Qwen2.5VL-3B on SpatialEval benchmark.
"""
...
def main(output_dir: str = "spacethinker_results", first_k: int = None):
    ...
    summary_file = output_dir / "spacethinker_summary.json"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", default="spacethinker_results")
